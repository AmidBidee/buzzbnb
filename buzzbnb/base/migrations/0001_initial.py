    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categorie', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='base.Categorie')),
        ...
        migrations.AddField(
            model_name='artist',
            name='categorie',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='base.Categorie'),
        ),
        migrations.AddField(
            model_name='artist',
            name='genre',
